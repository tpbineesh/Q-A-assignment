...
Original file is located at
    https://colab.research.google.com/drive/1r6baCMNfL3e08k7BYKMqxTQCCLmbNooG
"""
...
y=dataset12['Attrition']
x=dataset12.drop(['Attrition'],axis=1)
...
"""From the model evaluated, the best one is logistic regression with 87 % accuracy and high precision level for categorical variables."""